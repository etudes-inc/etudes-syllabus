...
set HIBERNATE_DIALECT=net.sf.hibernate.dialect.HSQLDialect
rem set HIBERNATE_DIALECT=net.sf.hibernate.dialect.MySQLDialect
rem set HIBERNATE_DIALECT=net.sf.hibernate.dialect.Oracle9Dialect

set MAVEN_TARGET=C:\java\projects\syllabus\syllabus-comp-shared\target\classes
set MAVEN_SRC=C:\java\projects\syllabus\foo
